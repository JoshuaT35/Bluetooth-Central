...
SWITCH_CHARACTERISTIC_ACCEL_X_UUID = "19B10001-E8F2-537E-4F6C-D104768A1214"  # changed from 10 -> 01
...
async def connect_to_arduino():
    ...
    async with BleakClient(selected_device.address) as client:
        ...
        try:
            value = await client.read_gatt_char(SWITCH_CHARACTERISTIC_ACCEL_X_UUID)
            print(f"Value from characteristic {SWITCH_CHARACTERISTIC_ACCEL_X_UUID}: {value}\n")
